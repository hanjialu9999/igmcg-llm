...
ckpt = torch.load('archive_unused/checkpoints_backup/_stab_ckpt/final_model.pt', map_location='cpu', weights_only=True)
model.load_state_dict(ckpt['model_state_dict'])
model.eval()
vocab = load_vocab('archive_unused/checkpoints_backup/_stab_ckpt/vocab.json')
print('Model loaded from _stab_ckpt')
