...
tests/           正式 pytest 单元测试（已纳入 git 跟踪）：test_config_loader.py / test_transformer.py / test_generation_pipeline.py / test_new_mechanisms.py 等（当前 203 passed / 1 skipped）
