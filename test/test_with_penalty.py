...
for penalty in penalties:
    print('\n' + '='*100)
    print(f'  FINAL MODEL WITH REPETITION PENALTY: {penalty}')
    print(f'  Parameters: Temp=0.65, Top-K=42, Repetition Penalty={penalty}')
    print('='*100 + '\n')
...
print('='*100)
print('  COMPARISON: Higher penalty (2.0+) reduces repetition but may hurt fluency')
print('='*100 + '\n')
